...
HD_PWD='/home/stavros/zu3eg/EBAZ4205_Petalinux_Base/EBAZ4205_Petalinux_Base.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_proc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zynq_proc_wrapper.tcl -notrace
